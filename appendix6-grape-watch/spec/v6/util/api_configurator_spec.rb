...
describe "ApiConfigurator v6" do
  let(:app) { Struct.new(:db) {
    ...
    def configure(database)
      @db= database || Watch::V6::Util::ActionDb.new
    end
    def db
      @db
    end
  ...
  let :middleware do
    Watch::V6::Util::ApiConfigurator.new(app)
  end
  ...
  it "No database" do
    ...
    expect(app.db.class).to eql(Watch::V6::Util::ActionDb)
  end
  it "Mock database" do
